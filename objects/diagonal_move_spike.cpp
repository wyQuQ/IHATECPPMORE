...
void DiogonalRigMoveSpike::Start() {
    // 设置精灵资源和初始状态
...
void DiogonalRigMoveSpike::Update() {
 
}

void DiogonalRigMoveSpike::OnCollisionStay(const ObjManager::ObjToken& other, const CF_Manifold& manifold) noexcept {
