...
void RightMoveBlock::Update() {
   
}

void RightMoveBlock::OnCollisionEnter(const ObjManager::ObjToken& other_token, const CF_Manifold& manifold) noexcept {
